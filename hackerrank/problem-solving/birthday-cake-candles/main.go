...
func birthdayCakeCandles(candles []int32) int32 {
	var tallestCandle int32 = 0
	candleCount := make(map[int32]int32)
	for _, candleUnitsHigh := range candles {
		candleCount[candleUnitsHigh]++
		if candleUnitsHigh > tallestCandle {
			tallestCandle = candleUnitsHigh
		}
	}
	return candleCount[tallestCandle]
}
